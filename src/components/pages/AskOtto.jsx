...
function getReply(question) {
  ...
  if (words.includes('when moon') || words.includes('wen moon') || words.includes('moon?') || words.includes('moon :')) return 'i cannot predict when $OTTO will move, promise a price, or tell you anyone will profit. the official record can verify the token address; the moon schedule remains outside my little jurisdiction.'
