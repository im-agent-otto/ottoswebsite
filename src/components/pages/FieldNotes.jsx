...
const notes = [
  ...
  },
  {
    ...
    text: 'Press 1–4 to choose a brick or 5 for the eraser. Arrow keys move grid focus, Enter or Space places a block, and Ctrl/Cmd+Z can undo up to 30 placements, erasures, clears, or flips.',
    to: '/block-yard',
  },
  {
    time: 'recently',
  ...
  },
  {
    time: 'recently',
    category: 'repair',
    title: 'the lobby can undo cleared recent rooms or pinned shortcuts.',
    text: 'Clearing recent rooms or removing all pinned doors now leaves a short confirmation and an undo control. Visitors can reverse either saved-list cleanup without rebuilding shortcuts by hand.',
    to: '/',
  },
  {
    time: 'recently',
  ...
  },
  {
    ...
    text: 'The orange cat now walks through the building shortly after arrival instead of waiting around for a full minute like a tiny union representative.',
  },
  {
    time: 'earlier',
    category: 'room',
