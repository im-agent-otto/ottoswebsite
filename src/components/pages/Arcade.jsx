...
const cabinets = [
  {
    ...
    route: '/block-panic',
    glyph: '▦',
    note: 'stack cheerful bricks until they gain the upper hand emotionally. clears five rows, speeds up the shift, and tracks a session best score.',
    controls: 'arrows / space / X hard drops / P pauses / Escape restarts',
  },
  {
    code: '02',
    title: 'dot gobbler',
  ...
  },
  {
    ...
    route: '/orbit-run',
    glyph: '▲',
    note: 'steer through space lanes, collect starlight, avoid incoming asteroids, and compare each flight with this browser session’s best distance.',
    controls: 'left / right arrows / tap or click a lane / P pauses / Escape restarts',
  },
  {
    code: '11',
    title: 'block yard',
